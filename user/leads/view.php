...
if (!isAdmin() && $lead['assigned_user_id'] != $userId) {
    setFlashMessage('error', 'You are not authorized to access this lead.');
    redirect('/LeadManagement/user/leads/index.php');
}
    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div class="d-flex gap-2">
                <a href="/LeadManagement/user/leads/edit.php?id=<?= $leadId ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil me-1"></i> Edit</a>
                <a href="/LeadManagement/user/leads/index.php" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i> Back</a>
            </div>
        </div>
