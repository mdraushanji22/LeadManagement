...
if ($assignedUser) { $where[] = "l.assigned_user_id = ?"; $params[] = $assignedUser; }
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="page-header">
            <h4><i class="bi bi-people me-2"></i>Manage Leads</h4>
        ...
        <div class="filter-container">
            <form method="GET" action="">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 col-sm-6">
                        ...
                        <select class="form-select form-select-sm" name="assigned_user">
                            ...
                            <option value="<?= $u['id'] ?>" <?= $assignedUser == $u['id'] ? 'selected' : '' ?>><?= escape($u['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                ...
                <div class="mt-2 d-flex gap-2">
                    ...
                    <a href="/LeadManagement/admin/leads/index.php" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-counterclockwise me-1"></i>Reset</a>
                </div>
            </form>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>#<?= $lead['id'] ?></td>
                            <td><a href="/LeadManagement/admin/leads/view.php?id=<?= $lead['id'] ?>" class="text-decoration-none fw-medium"><?= escape($lead['customer_name']) ?></a></td>
                            ...
                            <td><?= escape($lead['product_service']) ?></td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="/LeadManagement/admin/leads/view.php?id=<?= $lead['id'] ?>" class="btn btn-outline-primary" title="View"><i class="bi bi-eye"></i></a>
                                    <a href="/LeadManagement/admin/leads/edit.php?id=<?= $lead['id'] ?>" class="btn btn-outline-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                                    <a href="/LeadManagement/admin/leads/assign.php?id=<?= $lead['id'] ?>" class="btn btn-outline-info" title="Assign"><i class="bi bi-person-plus"></i></a>
                                    <form method="POST" action="/LeadManagement/admin/leads/delete.php" class="delete-form d-inline" style="margin:0;">
                                        <?= csrfField() ?>
